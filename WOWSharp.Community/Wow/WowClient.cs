...
namespace WOWSharp.Community.Wow
{
	...
	public class WowClient : ApiClient
    {
        ...
        {
            return GetAsync<RealmStatusResponse>("/data/wow/realm/status", null);
        }
        ...
        public Task<RealmStatusResponse> GetRealmStatusAsync(string[] realms)
        {
            ...
            return GetAsync<RealmStatusResponse>("/data/wow/realm/status" + queryString, null);
        }
        ...
        {
            return GetAsync<BattleGroupsResponse>("/data/wow/data/battlegroups/index", null);
        }
        ...
        public Task<Character> GetCharacterAsync(string realm, string characterName, CharacterFields fieldsToRetrieve)
        {
            ...
            return GetAsync<Character>(
                    "/data/wow/character/" + GetRealmSlug(realm) + "/" + Uri.EscapeUriString(characterName) + queryString,
                    null);
        }
        ...
        public Task<Guild> GetGuildAsync(string realm, string guildName, GuildFields fieldsToRetrieve)
        {
            ...
            return GetAsync<Guild>(
                    "/data/wow/guild/" + GetRealmSlug(realm) + "/" + Uri.EscapeUriString(guildName) + queryString, null);
        }
        ...
        {
            var files = await GetAsync<AuctionFilesResponse>("/data/wow/auction/data/" + GetRealmSlug(realm), null);
        ...
        {
            return GetAsync<Item>("/data/wow/item/" + itemId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<ItemCategoryNamesResponse>("/data/wow/data/item/classes", null);
        }
        ...
        {
            return GetAsync<ItemSet>("/data/wow/item/set/" + itemSetId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        public async Task<IList<CharacterClass>> GetClassesAsync()
        {
            ...
            var classesResponse = await GetAsync<ClassesResponse>("/data/wow/data/character/classes", null);
        ...
        public async Task<IList<CharacterRace>> GetRacesAsync()
        {
            ...
            var racesResponse = await GetAsync<RacesResponse>("/data/wow/data/character/races", null);
        ...
        public Task<PvpLeaderboardResponse> GetPvpLeaderboardAsync(PvpBracket type)
        {
            ...
            return GetAsync<PvpLeaderboardResponse>("/data/wow/leaderboard/" + strType, null);
        }
        ...
        {
            return GetAsync<GuildRewardsResponse>("/data/wow/data/guild/rewards", null);
        }
        ...
        {
            return GetAsync<GuildPerksResponse>("/data/wow/data/guild/perks", null);
        }
        ...
        {
            return GetAsync<Achievement>("/data/wow/achievement/" + achievementId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<AchievementsResponse>("/data/wow/data/character/achievements", null);
        }
        ...
        {
            return GetAsync<AchievementsResponse>("/data/wow/data/guild/achievements", null);
        }
        ...
        {
            return GetAsync<Quest>("/data/wow/quest/" + questId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<RecipeInfo>("/data/wow/recipe/" + recipeId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        public Task<ChallengesResponse> GetChallengeLeadersAsync(string realmName)
        {
            ...
            return GetAsync<ChallengesResponse>("/data/wow/challenge/" + slug, null);
        }
        ...
        {
            return GetAsync<BattlePetAbility>("/data/wow/battlePet/ability/" + abilityId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<BattlePetSpecies>("/data/wow/battlePet/species/" + speciesId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<BattlePetTypesResponse>("/data/wow/data/pet/types", null);
        }
        ...
        {
            return GetAsync<Spell>("/data/wow/spell/" + spellId.ToString(CultureInfo.InvariantCulture), null);
        }
        ...
        {
            return GetAsync<TalentsResponse>("/data/wow/data/talents", null);
        }
